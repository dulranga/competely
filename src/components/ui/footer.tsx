import { type FooterLink, FooterSection } from "~/components/ui/footer-section";
import { Logo } from "~/components/ui/logo";
import { SocialIcons, SocialLink } from "~/components/ui/social-link";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Empowering competitors worldwide to achieve their goals and reach
              new heights.
            </p>
          </div>
