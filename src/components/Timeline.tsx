          ...
          {stages.map((stage, index) => (
            ...
            >
              ...
              <div
                ...
                } ${hoveredStage === stage.id ? 'scale-125 animate-pulse' : ''}`}
              ></div>

              {/* Content */}
              <div className={`mt-4 text-center max-w-[200px] transition-all duration-300 ${
                ...
                <p className={`text-sm text-gray-600 mt-1 transition-opacity duration-300 ${
                  hoveredStage === stage.id ? 'opacity-100' : 'opacity-70'
                }`}>{stage.description}</p>
              </div>
            </div>
          ))}
