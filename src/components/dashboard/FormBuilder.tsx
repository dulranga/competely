            ...
            <div className="space-y-6 px-4">
                ...
                <div className="flex items-start gap-4 group">
                    <Textarea
                        ...
                        className="text-lg text-muted-foreground border border-border/60 px-6 focus-visible:ring-0 placeholder:text-muted-foreground/20 min-h-16 py-4 bg-card shadow-sm font-medium rounded-2xl transition-all resize-none w-full"
