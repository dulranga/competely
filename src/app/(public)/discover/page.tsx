...
export default function DiscoverPage() {
    ...
    return (
        <div className="min-h-screen bg-[#fbf6f3] pb-20">
            {/* Search Header */}
                ...
                {!isSearching && (
                    <div className="space-y-16 animate-in fade-in duration-500">
                        ...
                        <section className="space-y-8 bg-gray-200/50 -mx-4 md:-mx-8 px-4 md:px-8 py-12">
                            ...
                            <div className="flex overflow-x-auto gap-6 pb-6 snap-x snap-mandatory scrollbar-none justify-center">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 animate-in slide-in-from-bottom-4 duration-500">
                        ...
                        <aside className="lg:w-64 shrink-0 hidden lg:block">
                            <div className="sticky top-8">
                                <h3 className="font-bold mb-4 text-xl">Keywords</h3>
                                <FilterSidebar />
                            </div>
                        </aside>
