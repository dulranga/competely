...
const Login: FC<PageProps> = ({}) => {
  ...
  const login = async (data: unknown) => {
    ...
    if (!d.is_agreed)
      return toast(`Please accept our Terms of Use and Privacy Policy`);
    ...
    <div className="relative grid place-items-center min-h-screen py-10">
      <Card className="max-w-xl w-full py-16 border-none ring-0">
        ...
        <CardContent className="px-4 md:px-16">
          <Dialog
            open={showUnverifiedAlert}
            onOpenChange={setShowUnverifiedAlert}
          >
            <DialogContent
            ...
            >
              ...
              <p>
                You need to verify your email address before logging in. Please
              ...
              <div className="grid gap-6">
                ...
                <div>
                  ...
                  <Link
                    ...
                    className="text-xs underline text-right block"
                  >
                    Forgot password?
                  </Link>
                </div>
