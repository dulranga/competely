...
--> statement-breakpoint
ALTER TABLE "competition_events" ALTER COLUMN "notification_enabled" SET DEFAULT true;--> statement-breakpoint
ALTER TABLE "competitions" ADD COLUMN "description" text;--> statement-breakpoint
ALTER TABLE "competition_events" ADD COLUMN "location" text;--> statement-breakpoint
ALTER TABLE "competition_events" ADD COLUMN "is_system" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "competition_rounds" ADD COLUMN "is_system" boolean DEFAULT false NOT NULL;--> statement-breakpoint
